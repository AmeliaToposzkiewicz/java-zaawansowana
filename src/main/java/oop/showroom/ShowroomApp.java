...
public class ShowroomApp {
    ...
    private void addCar(VehicleService vehicleService) {
        ...
        car.setBrand(BrandType.valueOf(carBrand));
    ...
    private void addMotorbike(VehicleService vehicleService) {
        ...
        System.out.println("Podaj typ:  CHOPPER, ENDURO");
        String type = SCANNER.next();
        motorbike.setMotorbikeType(MotorbikeType.valueOf(type));
    ...
    private void showMenu() {
        System.out.println("Jaką operację chesz wykonać?");
        ...
        System.out.println("4 - wyświetl wszytskie pojazdy dla danej marki");
    ...
    private void init(VehicleService vehicleService) {
        ...
        Motorbike bmw = new Motorbike(BrandType.BMW, ModelType.X6, ColourType.GREEN, EngineType.V8, 5000,

...
public class Motorbike extends Vehicle {
    ...
    public Motorbike(BrandType brand, ModelType model, ColourType colour, EngineType engine,
                     double mileage, GearboxType gearboxType, boolean isUsed, MotorbikeType motorbikeType,
                     String motorbikeDrive) {

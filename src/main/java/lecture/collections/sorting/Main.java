...
class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Mniejsza porownana do wiekszej " + num.compareTo(bigger)); // -1
        System.out.println("Większta porownana do mniejszej " + bigger.compareTo(num)); // 1
        ...
        //Porównywaie po polach w klasach
